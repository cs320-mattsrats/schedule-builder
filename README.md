...
The section that displays different courses is formatted into colorful side by side textblocks of potential courses labelled with their course IDs. These serve as an array of potential courses the student is considering, and allows a student to add them to their cart. Once added, a student can click generate to generate random schedules that follow the non overlapping schedule algorithm to create valid scedules. Moreover, clicking the calendar button in the right corner of a schedule will copy it to the home page. This section intends to allow students to have a broad overview of potential courses they coudl take.
